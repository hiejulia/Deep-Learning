package com.deeplearning.titanicsurvivalprediction.titanicsurvivalprediction;

import java.util.HashMap;
import java.util.Map;

import com.deeplearning.titanicsurvivalprediction.SparkConfig;
import com.deeplearning.titanicsurvivalprediction.utils.Util;
...
public class SurvivalPredictionMLP {
    public static void main(String[] args) {
        SparkSession spark = SparkConfig.getInstance();
        ...
        MultilayerPerceptronClassificationModel model = mlp.fit(trainingData); // train data
